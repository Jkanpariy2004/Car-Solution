...
if (isset($_REQUEST['delete'])) {
    $id = $_REQUEST['delete'];
    $editimg = "select *from registration where id='$id'";
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="overflow-x: auto;">
                    <div class="table-container">
                        <h1 class="text-center p-3">Register Data</h1>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="table-light border-bottom border-dark" style="text-align: left;">
                                        <td class="text-center" style="text-align: left;"><img class="rounded-circle" src="Car-Service-Project/image/<?php echo $row['image']; ?>" width="50" height="50"></td>
                                        <td class="text-center"><?php echo $row['username'] ?></td>
                                        <td class="text-center"><?php echo $row['email'] ?></td>
                                        <td class="text-center"><?php echo $row['phone'] ?></td>
                                        <td class="text-center"><?php echo $row['gender'] ?></td>
                                        <td class="text-center"><?php echo $row['hobby'] ?></td>

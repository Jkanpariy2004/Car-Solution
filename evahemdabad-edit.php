...
if (isset($_REQUEST['edit'])) {
    $id = $_REQUEST['edit'];
    $sql = "select * from evahemdabad where id='$id' ";
...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    // Assuming station_name is the unique identifier for the record you want to update
    $sql = "update evahemdabad 
            set address = '$address',
                time = '$time',
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="table-light border-bottom border-dark">
                                            ...
                                            <td class="text-center"><?php echo $row['station_name'] ?></td>
                                            <td class="text-center"><?php echo $row['address'] ?></td>
                                            <td class="text-center"><?php echo $row['time'] ?></td>
                                            <td class="text-center"><?php echo $row['Chargingpoint'] ?></td>
                                            <td class="text-center"><?php echo $row['direction'] ?></td>

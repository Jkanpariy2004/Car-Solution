...
if (isset($_REQUEST['btnlogin'])) {
    ...
    if (empty($errors)) {
        $sql = "select * from mechanic_register where username='$user' AND BINARY password='$password'";
    ...
    <div class="login">
        <form method="POST" class="loginbg p-4 wow fadeIn" data-wow-delay="0.1s" style="max-width: 50%;">
            <div class="text-center">
                <h1 class="m-3">Mechanic Login</h1>
            </div>
            <?php
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-3 <?php if (isset($errors['username'])) echo 'is-invalid'; ?>" autocomplete="off" id="floatingInput" name="user" placeholder="" value="<?php echo htmlspecialchars($user); ?>">

...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    $sql = " insert into home_slider(image,description) values ('$image','$des') ";
    mysqli_query($db, $sql);
...
if (isset($_REQUEST['delete'])) {
    ...
    $editimg = "select *from home_slider where id='$id'";
            ...
            <div id="content">
                <div class="box">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="formFile" class="form-label">Upload Slider Imaxge</label>
                    ...
                    <div class="table-container">
                        ...
                        <table id="example" class="display dataTable table-dark table-bordered text-center" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="table-light border-bottom border-dark" style="text-align: center;">
                                        ...
                                        <td class="data" style="text-align: center;">
                                            <a href="home-slider-edit.php?edit=<?php echo $row['id'] ?>" class="fs-2 text-dark active"><i class="bx bx-edit"></i></a>
                                        </td>
                                        <td class="data" style="text-align: center;">
                                            <a href="home-slider.php?delete=<?php echo $row['id']; ?> " class="fs-2 text-dark active" onclick=" return confirm('Are You Sure Record Delete !!!') "><i class='bx bx-trash'></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }

...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    if (move_uploaded_file($image_tmp, 'Car-Service-Project/image/' . $image)) {
        $sql = "insert into home_team (image, name, post) values ('$image', '$name', '$post')";
        print_r($sql);
        if (mysqli_query($db, $sql)) {
            echo '<script>alert("Team Member details uploaded successfully.");</script>';
            ...
            <div id="content">
                <div class="box">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control rounded-3" autocomplete="off" id="floatingInput" name="post" placeholder="" required>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="table-light border-bottom border-dark">
                                        ...
                                        <td class="data">
                                            <a href="our-team-edit.php?edit=<?php echo $row['id'] ?>" class="fs-2 text-dark active"><i class="bx bx-edit"></i></a>
                                        </td>
                                        <td class="data">
                                            <a href="our-team.php?delete=<?php echo $row['id']; ?> " class="fs-2 text-dark active" onclick=" return confirm('Are You Sure Record Delete !!!') "><i class='bx bx-trash'></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }

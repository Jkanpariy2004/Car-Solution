...
if (isset($_REQUEST['edit'])) {
    $id = $_REQUEST['edit'];
    $sql = "select * from add_car_rent where id='$id'";
...
if (isset($_REQUEST['btnsubmit'])) {
    // $id = $_REQUEST['edit']; // Make sure to capture the ID from the form
    ...
    $sql = "update add_car_rent 
            set image='$im', 
                name='$carname', 
                dprice='$dayprice', 
                dfuelcharge='$dayfuelprice', 
                wprice='$weekprice', 
                wfuelprise='$weekfuelprice', 
                mprice='$monthprice', 
                mfuelprice='$monthfuelprice' 
            where id='$id'";
                    ...
                    <div class="box">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" value="<?php echo $return['name'] ?>" autocomplete="off" id="floatingInput" name="carname" placeholder="" required>
                                <label for="floatingInput">Enter Car Name</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['dprice'] ?>" id="floatingInput" name="dayprice" placeholder="" required>
                                <label for="floatingInput">Enter Day Wise Price</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['dfuelcharge'] ?>" id="floatingInput" name="dayfuelprice" placeholder="" required>
                                <label for="floatingInput">Enter Day Wise Fuel Price</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['wprice'] ?>" id="floatingInput" name="weekprice" placeholder="" required>
                                <label for="floatingInput">Enter Week Wise Price</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['wfuelprise'] ?>" id="floatingInput" name="weekfuelprice" placeholder="" required>
                                <label for="floatingInput">Enter Week Wise Fuel Price</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['mprice'] ?>" id="floatingInput" name="monthprice" placeholder="" required>
                                <label for="floatingInput">Enter month Wise Price</label>
                            </div>
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" value="<?php echo $return['mfuelprice'] ?>" id="floatingInput" name="monthfuelprice" placeholder="" required>
                                <label for="floatingInput">Enter month Wise Fuel Price</label>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-primary text-white mt-2 rounded-3 text-dark" name="btnsubmit">Update </button>
                            </div>
                        </form>
                    </div>
                    <div style="overflow-x:auto;">
                        <div class="table-container">
                            <h1 class="text-center p-3">Car Rental Service</h1>

...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    $sql = " insert into add_car_booking(image,name,price) values ('$image','$name','$price') ";
    mysqli_query($db, $sql);

    echo "<script>
        alert('Car Booked Successfully..');
    </script>";
    header("location:add-car-booking.php");
}

if (isset($_REQUEST['delete'])) {
    $id = $_REQUEST['delete'];
    $editimg = "select *from add_car_booking where id='$id'";
    $img1 = mysqli_query($db, $editimg);
    $return = mysqli_fetch_array($img1);
    unlink('image/' . $return['image']);


    $sql = "delete from add_car_booking where id='$id' ";
    mysqli_query($db, $sql);
    header("location:add-car-booking.php");
}
                ...
                <div class="container-fluid">
                    <div class="box">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <label for="floatingInput">Enter Car Price</label>
                            </div>
                    ...
                    <div style="overflow-x:auto;">
                        <div class="table-container">
                            <h1 class="text-center p-3">Car Data</h1>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="table-light border-bottom border-dark">
                                            ...
                                            <td><a href="add-car-booking-edit.php?edit=<?php echo $row['id'] ?>" class="fs-2 text-dark active" role="button" aria-pressed="true"><i class='bx bx-edit'></i></a></td>
                                            <td>
                                                <a href="add-car-booking.php?delete=<?php echo $row['id'] ?>" onclick="return confirm('Are You Sure Record Delete !!!')" class="fs-2 text-dark active" role="button" aria-pressed="true">

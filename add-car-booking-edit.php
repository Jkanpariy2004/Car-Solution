...
if (isset($_REQUEST['edit'])) {
    $id = $_REQUEST['edit'];
    $sql = "select * from add_car_booking where id='$id'";
                ...
                <div class="container-fluid">
                    <div class="box">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control rounded-3" autocomplete="off" id="floatingInput" value="<?php echo $return['price']; ?>" name="price" placeholder="" required>

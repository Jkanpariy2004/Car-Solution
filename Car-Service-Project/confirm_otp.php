...
if (isset($_REQUEST['submit'])) {
    ...
    if ($password == $conpassword) {
        $eee = $_SESSION['email'];
        $que = "update registration set `password`='$conpassword' , `conpassword`='$conpassword' where email='$eee'";

        $re =  mysqli_query($db, $que);
        if ($re) {
            // header('location:email.php');
            $errors['success'] = "Your Password has been changed.";
        }
    } else {
        $errors['conpass'] = "New Password and Confirm Password Does not Match";
    }
}
    ...
    <div class="login">
        <form method="POST" class="loginbg p-4 wow fadeIn" data-wow-delay="0.1s" style="max-width: 50%;">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-3 <?php if (isset($errors['conpass'])) echo 'is-invalid'; ?>" autocomplete="off" id="floatingInput" name="password" placeholder="" style="background-color: transparent; color: white;">
                <label for="floatingInput" style="color: white;">Enter Your New Password</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-3 <?php if (isset($errors['conpass'])) echo 'is-invalid'; ?>" autocomplete="off" id="floatingInput" name="conpassword" placeholder="" style="background-color: transparent; color: white;">
                <label for="floatingInput" style="color: white;">Enter Your Confirm Password</label>
                <?php
                if (isset($errors['copass'])) {
                    echo '<h6 class="alert alert-danger">' . $errors['conpass'] . '</h6>';
                }
                ?>
            </div>
            ...
            <p class="mt-3 text-center text-white">Do you have an account?<a href="Login.php" class="link-primary link-offset-2 text-white link-underline-opacity-25 link-underline-opacity-100-hover"> Login</a></p>
        </form>
    </div>

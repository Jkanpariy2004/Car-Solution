...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="find-fual.php" class="dropdown-item active">Find Fuel Data</a>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/find-fual.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 wow slideInDown">Find Fuel Station</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase wow slideInDown">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Pages</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Find Fuel Station</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container wow fadeIn m-auto" id="team">
        <div class="row">
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-surat.php">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-bangalore.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-ahemdabad.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-hydrabad.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-pune.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-mumbai.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-Rajkot.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">
            ...
            <a class="col-xs-12 col-sm-6 col-md-3 p-0 cardbox" href="fual-Vadodra.php">
                <div class="image-flip">
                    <div class="mainflip flip-0">
                        <div class="frontside">
                            <div class="card">

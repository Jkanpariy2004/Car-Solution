    ...
    <div class="login">
        <form method="POST" class="loginbg p-4 wow fadeIn" data-wow-delay="0.1s" style="max-width: 50%;">
            ...
            <div class="text-white mb-3">
                <p>Otp send this Email id: <?php echo $_SESSION['email']; ?> </p>
            </div>
            <?php
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-3 <?php if (isset($errors['error'])) echo 'is-invalid'; ?>" autocomplete="off" id="floatingInput" name="otp" placeholder="" style="background-color: transparent; color: white;">
                <label for="floatingInput" style="color: white;">Enter Your OTP</label>
                <?php
                if (isset($errors['error'])) {
                    echo '<h6 class="alert alert-danger">' . $errors['error'] . '</h6>';
                }
                ?>
            </div>

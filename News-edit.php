...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    $daata = "update news set image='$im' where id='$id'";
...
if (isset($_REQUEST['btnsubmit'])) {
    ...
    $sql = " update news set title='$title',description='$des' where id='$id' ";
    mysqli_query($db, $sql);
                ...
                <div class="box">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control rounded-3" autocomplete="off" id="floatingInput" value="<?php echo $return['title']; ?>" name="title" placeholder="" required>
                            <label for="floatingInput">Enter News Title</label>
                        </div>
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control rounded-3" autocomplete="off" id="floatingInput" value="<?php echo $return['description']; ?>" name="description" placeholder="" required>
